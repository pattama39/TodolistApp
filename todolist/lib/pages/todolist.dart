...
class _TodolistState extends State<Todolist> {
        ...
        return Card(
          child: ListTile(
            ...
            onTap:() {
              ...
              }); // กด Card ไปหน้าถัดไป | then หลังจากกลับมาหน้าหลักแล้วให้ทำการรีเฟรชหน้า 1 ครั้ง
            }, 
          )
        );
      }
  ...
  Future<void> getTodolist() async {
    List alltodo = [];
    var url = Uri.http('192.168.100.6:8000', '/api/all-todolist');
